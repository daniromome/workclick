...
const routes: Routes = [
  ...
  { path: 'vacantes', loadChildren: () => import('./modules/vacantes/vacantes.module').then(m => m.VacantesModule) },
  { path: 'nueva-vacante', loadChildren: () => import('./modules/nueva-vacante/nueva-vacante.module').then(m => m.NuevaVacanteModule) },
  { path: 'list-candidatos', loadChildren: () => import('./modules/list-candidatos/list-candidatos.module').then(m => m.ListCandidatosModule) }
];
